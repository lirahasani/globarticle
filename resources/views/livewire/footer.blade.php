<div>
    <section class="bg-black text-white py-16 w-full text-center">
        <div class="container mx-auto px-12">
            <div class="table w-full">
                <div class="block sm:table-cell">
                    <p class="uppercase text-grey text-lg sm:mb-6">Links</p>
                    <ul class="list-reset text-xs mb-6">
                        <li class="mt-4 inline-block mr-2 sm:block sm:mr-0">
                ...
                <div class="block sm:table-cell">
                    <p class="uppercase text-grey text-lg sm:mb-6">Legal</p>
                    <ul class="list-reset text-xs mb-6">
                        <li class="mt-4 inline-block mr-2 sm:block sm:mr-0">
                ...
                <div class="block sm:table-cell">
                    <p class="uppercase text-grey text-lg sm:mb-6">Social</p>
                    <ul class="list-reset text-xs mb-6">
                        <li class="mt-4 inline-block mr-2 sm:block sm:mr-0">
                ...
                <div class="block sm:table-cell">
                    <p class="uppercase text-grey text-lg sm:mb-6">Company</p>
                    <ul class="list-reset text-xs mb-6">
                        <li class="mt-4 inline-block mr-2 sm:block sm:mr-0">
